...
<p align="center">
  <a href="README.md">English</a> · <strong>简体中文</strong> · <a href="https://yurunchen.github.io/GUI-Anything/">项目主页</a>
</p>
...
<p align="center">
  <img src="assets/demo/run-capture-guide-loop.gif" alt="像素动画：GUI-Anything 在长 Claude Code 会话中完成 Run、Capture、Guide 三幕循环" width="960">
</p>

<p align="center"><em>运行会话，记录路径，指引下一步。</em></p>
...
<p align="center">
  <a href="assets/video/video.mp4">打开本地 MP4</a>
</p>
...
- 补充 knowledge retrieval 与 strict resume 的短演示片段
