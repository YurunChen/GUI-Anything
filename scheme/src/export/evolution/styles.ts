...
html { scroll-behavior: smooth; background: var(--bg-primary, #1a1b26); }
body {
  margin: 0;
...
.evo-topbar {
  ...
  padding: 11px 20px;
  background: color-mix(in srgb, var(--bg-secondary, #16161e) 62%, transparent);
...
.node {
  ...
  background: color-mix(in srgb, var(--bg-secondary, #16161e) 82%, transparent);
